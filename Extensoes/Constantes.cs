namespace CadastroVendedores.Extensoes
{
    public class Constantes
    {
        ...
        public const string MsgDesejaCancelar = "Desja limpar os campos?";
        public const string MsgVoltarTelaInicial = "Deseja voltar a tela inicial?";
